...
// derives its rows from the same records so the two cannot disagree. The whole
// card is a link there, same as the Income / Expense card on the dashboard.
export default function AssetsLiabilities() {
  ...
  return (
    <Link href="/assets-liabilities" className="card-link" aria-label="Open assets and liabilities detail">
