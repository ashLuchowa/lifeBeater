...
export const seedData = {
  ...
  bills,
  notes,
  // Rough full-year income estimate, plus the financial year it covers, both
  // refreshed onto the current week's snapshot from the Income / Expense ledger
  // (see components/ProjectedIncomeSync.jsx).
  projectedIncome: 0,
  projectedIncomeFy: "",
};
